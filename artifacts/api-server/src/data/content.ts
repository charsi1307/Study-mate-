...
export const subjects: SubjectData[] = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { id: "ss-2", subjectId: "social-science", number: 2, title: "Socialism in Europe and the Russian Revolution", description: "Rise of socialism and the Russian Revolution of 1917", youtubeVideoId: "", duration: "30:45" },
      { id: "ss-3", subjectId: "social-science", number: 3, title: "Nazism and the Rise of Hitler", description: "Rise of Hitler, Nazi ideology and World War II", youtubeVideoId: "", duration: "32:30" },
      ...
      { id: "ss-5", subjectId: "social-science", number: 5, title: "Pastoralists in the Modern World", description: "Lives of pastoral communities and colonial impact", youtubeVideoId: "", duration: "26:00" },
      ...
      // Geography
      { id: "ss-7", subjectId: "social-science", number: 7, title: "India – Size and Location", description: "India's geographical position, size and neighbouring countries", youtubeVideoId: "", duration: "18:20" },
      { id: "ss-8", subjectId: "social-science", number: 8, title: "Physical Features of India", description: "Himalayan mountains, northern plains, plateaus and coastal plains", youtubeVideoId: "", duration: "22:15" },
      { id: "ss-9", subjectId: "social-science", number: 9, title: "Drainage", description: "River systems of India, lakes and their significance", youtubeVideoId: "", duration: "24:00" },
      ...
      { id: "ss-11", subjectId: "social-science", number: 11, title: "Natural Vegetation and Wildlife", description: "Types of vegetation, forests and conservation efforts", youtubeVideoId: "", duration: "23:00" },
      ...
      // Political Science
      { id: "ss-13", subjectId: "social-science", number: 13, title: "Democracy in the Contemporary World", description: "Democratic regimes and transitions across the world", youtubeVideoId: "", duration: "19:30" },
      { id: "ss-14", subjectId: "social-science", number: 14, title: "What is Democracy? Why Democracy?", description: "Features, merits and demerits of democracy", youtubeVideoId: "", duration: "20:00" },
      { id: "ss-15", subjectId: "social-science", number: 15, title: "Constitutional Design", description: "Indian constitution, its making and guiding values", youtubeVideoId: "", duration: "25:40" },
      { id: "ss-16", subjectId: "social-science", number: 16, title: "Electoral Politics", description: "Elections, political parties and representation in India", youtubeVideoId: "", duration: "22:10" },
      { id: "ss-17", subjectId: "social-science", number: 17, title: "Working of Institutions", description: "Parliament, executive, judiciary and their functions", youtubeVideoId: "", duration: "24:30" },
      { id: "ss-18", subjectId: "social-science", number: 18, title: "Democratic Rights", description: "Fundamental rights and their enforcement in India", youtubeVideoId: "", duration: "20:45" },
      // Economics
      ...
      { id: "ss-21", subjectId: "social-science", number: 21, title: "Poverty as a Challenge", description: "Causes, extent and anti-poverty measures in India", youtubeVideoId: "", duration: "23:30" },
      { id: "ss-22", subjectId: "social-science", number: 22, title: "Food Security in India", description: "Food security, public distribution system and buffer stocks", youtubeVideoId: "", duration: "20:15" },
    ],
  },
  {
    id: "english",
